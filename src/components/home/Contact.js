...
import { investVariant } from "./Invest";
...
const Contact = () => {
  ...
  useEffect(() => {
    if (inView) {
      contactControls.start("end");
    } else {
      contactControls.start("start");
    }
  }, [contactControls, inView]);
  return (
    <div className="bg-darkblue text-white p-4 pb-32 md:p-12">
      <motion.div
        ...
        className="md:w-9/10 mx-auto grid md:grid-cols-2"
      >
        <div className="mr-5 lg:mr-10">
          <h4 className="my-8">ABOUT US</h4>
          <div className="font-light">
            <h3>PRIVATE COMMUNITY</h3> An unmatched peer group of Crypto experts
            Gain market insights and stay ahead of the curve with a peer group
            you’ll find nowhere else on earth. They say the best time to plant a
            tree was 20 years ago. The second best time is today. Join our
            community and become the best cryptocurrency investor you can be —
            by surrounding yourself with the people who make it easy.
          </div>
        </div>
