      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
        ...
        <div className="">
          ...
          <Accordion>
            <AccordionSummary
              ...
              id="panel2a-header"
            >
              <Typography className="">Should I buy Etherium</Typography>
            </AccordionSummary>
            <AccordionDetails>
              <Typography>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
        ...
        <div>
          ...
          <Accordion>
            ...
            >
              <Typography className="">
                Can i trade with money from my bank?
              </Typography>
            </AccordionSummary>
            <AccordionDetails>
              <Typography>
        ...
        <div>
          ...
          <Accordion>
            <AccordionSummary
              ...
              id="panel1a-header"
            >
              <Typography className="">What is Bitcoin?</Typography>
            </AccordionSummary>
            <AccordionDetails>
              <Typography>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
          ...
          <Accordion>
            ...
            >
              <Typography className="">
                Can i withdraw Bitcoin to my bank?
              </Typography>
            </AccordionSummary>
            <AccordionDetails>
              <Typography>
